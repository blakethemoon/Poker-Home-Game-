    ...
    const response = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        system: [
          ...
          '',
          'CRITICAL — How to identify chip color:',
          'Most poker chips have a white or light-colored CENTER FACE and white EDGE SPOTS/INSERTS.',
          'These white markings are DECORATIVE. They do NOT make the chip a "white" chip.',
          'The chip color is determined by its OUTER RIM and the main BODY COLOR visible along the edge of the stack.',
          'Example: A blue chip will have a blue outer ring and blue body — even if the center face is mostly white.',
          'Example: A red chip will have a red outer ring and red body — even if it has white edge inserts.',
          'NEVER classify a chip as white based on its center face or edge inserts.',
          'ALWAYS use the dominant rim/body color (red, blue, green, black, etc.) to classify each chip.',
          '',
