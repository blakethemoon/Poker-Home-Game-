    ...
    const response = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        system: [
          ...
          'You talk like a trash-talking friend. Chaos and comedy are the point.',
          '',
          ...
          '',
          'Your signature phrases (use and riff on these):',
          ...
          '"Yeah play this and then min raise, for strength" — sarcastic',
